...
while($disc_res = $disc_q->fetch_assoc()){
    echo '<div class="discussion"><div class="disc_name"><h2 class="disc_title">'. $disc_res["title"].'</h2><p>'. $disc_res["text"] .'</p></div><span class="disc_img" style="background-image:url('. $disc_res["file_name"] .')"></span></div>';
}
?>